...
@interface SDNewScanViewController ()<SGQRCodeScanManagerDelegate, SGQRCodeAlbumManagerDelegate>
...
@implementation SDNewScanViewController
...
//        YMDoctorHomePageViewController *jumpVC = [[ScanSuccessJumpVC alloc] init];
...
- (void)QRCodeScanManager:(SGQRCodeScanManager *)scanManager didOutputMetadataObjects:(NSArray *)metadataObjects {
    ...
    if (metadataObjects != nil && metadataObjects.count > 0) {
        ...
        NSString *doctorID =[obj stringValue];
        NSString *doctorStr =[doctorID substringFromIndex:7];
        homePageVC.doctorID =doctorStr;
        homePageVC.isRootVC = YES;
