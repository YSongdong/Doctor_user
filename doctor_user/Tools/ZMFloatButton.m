...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
      ...
      //  _bannerIV.layer.cornerRadius =  CGRectGetHeight(self.bannerIV.frame)/2;
      //  _bannerIV.layer.masksToBounds = YES;
        _bannerIV.backgroundColor = [UIColor clearColor];
