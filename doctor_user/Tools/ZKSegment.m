...
- (void)commonInit {
    ...
    self.itemStyleSelectedColor = ZK_UIColorFromRGBAlpha(13.0f, 95.0f, 255.0f, 1.0f);
    switch (self.segmentStyle) {
        case ZKSegmentLineStyle:
            self.zk_itemSelectedColor = ZK_UIColorFromRGBAlpha(66.0f, 126.0f, 214.0f, 1.0f);
            break;
...
- (void)buttonStyleFromSegmentStyle {
    switch (self.segmentStyle) {
        ...
        case ZKSegmentRectangleStyle:
            ...
            self.buttonStyleCornerRadius = 15.0f;
...
- (void)scrollToIndex:(NSInteger)index {
    [self itemClick:self.buttonList[index]];
}
