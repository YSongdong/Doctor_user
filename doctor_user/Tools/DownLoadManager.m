...
// 使用plist文件存储文件的总字节数
#define  TotalLengthPlist [[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"privateDoctor.plist"]
// 文件的已被下载的大小
...
//获取沙盒中Library/Caches路径里所有的文件
-(NSArray *)setObtainFilesAll{
    //沙盒中Library/Caches路径
    NSString *cachesPath = [NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) lastObject];
    NSArray *files = [[NSFileManager defaultManager] subpathsOfDirectoryAtPath:cachesPath error:nil];
