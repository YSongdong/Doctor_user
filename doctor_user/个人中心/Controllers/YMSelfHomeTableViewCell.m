...
@interface YMSelfHomeTableViewCell()
...
@implementation YMSelfHomeTableViewCell
...
-(void)initView{
    ...
    [_headerImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.height.mas_offset(29);
    }];
...
-(void)setHiddrightImage:(BOOL)hiddrightImage{
    _rightImageView.hidden = hiddrightImage;
}
