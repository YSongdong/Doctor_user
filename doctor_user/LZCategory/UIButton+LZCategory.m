...
- (void)LZSetbuttonType:(LZCategoryType)lzType {
    ...
    }else if(lzType == LZCategoryTypeRight){
        
        [self setImageEdgeInsets:UIEdgeInsetsMake(0, (imageSize.width + interval), 0, imageSize.width + interval)];
        
        [self setTitleEdgeInsets:UIEdgeInsetsMake(0,titleSize.width + interval+4, 0, (titleSize.width + interval))];
